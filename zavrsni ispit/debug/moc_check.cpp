...
QT_MOC_LITERAL(3, 16, 21) // "on_pushButton_clicked"
    ...
    "check\0answered\0\0on_pushButton_clicked"
};
...
void check::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (check::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&check::answered)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void check::answered(QString _t1)
{
