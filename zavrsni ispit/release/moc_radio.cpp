...
QT_MOC_LITERAL(3, 16, 21) // "on_pushButton_clicked"
    ...
    "radio\0answered\0\0on_pushButton_clicked"
};
...
void radio::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (radio::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&radio::answered)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject radio::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_radio.data,
...
// SIGNAL 0
void radio::answered(QString _t1)
{
